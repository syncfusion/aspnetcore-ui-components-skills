...
<ejs-dialog id="focusDialog" 
    ...
    <e-dialog-buttons>
        <e-dialog-button content="Submit" is-primary="true" on-click="onSubmit"></e-dialog-button>
    </e-dialog-buttons>
</ejs-dialog>
...
Allow users to close dialog with Escape key:
...
<script>
    function onKeyDown(event) {
        if (event.key === 'Escape') {
            var dialog = document.getElementById('escapeDialog').ej2_instances[0];
            dialog.hide();
        }
    }
</script>
...
Mark critical information dialogs as alerts:
...
<ejs-dialog id="alertDialog" 
    ...
    aria-modal="true">
    <e-content-template>
        <p role="alert">This is an important alert message.</p>
    </e-content-template>
    <e-dialog-buttons>
...
<e-dialog-buttons>
    <!-- ✗ Bad: Too vague -->
    <e-dialog-button content="OK"></e-dialog-button>
    
    <!-- ✓ Good: Descriptive action -->
    <e-dialog-button content="Save Changes" is-primary="true"></e-dialog-button>
    <e-dialog-button content="Cancel Changes"></e-dialog-button>
</e-dialog-buttons>
```
...
<ejs-dialog id="multiLangDialog" 
    ...
    width="500px">
    <e-dialog-buttons>
        <e-dialog-button content="@GetLocalizedText(language, "ok")" is-primary="true"></e-dialog-button>
        <e-dialog-button content="@GetLocalizedText(language, "cancel")"></e-dialog-button>
    </e-dialog-buttons>
    <e-content-template>
...
<ejs-dialog id="rtlDialog" 
    ...
    <e-dialog-buttons>
        <e-dialog-button content="موافق" is-primary="true"></e-dialog-button>
        <e-dialog-button content="إلغاء"></e-dialog-button>
    </e-dialog-buttons>
</ejs-dialog>
```
