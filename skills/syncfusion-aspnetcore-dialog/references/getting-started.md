...
<ejs-dialog id="buttonDialog" 
    ...
    <e-dialog-buttons>
        <e-dialog-button content="Delete" 
            is-primary="true" 
            on-click="handleDelete"></e-dialog-button>
        <e-dialog-button content="Cancel" 
            on-click="handleCancel"></e-dialog-button>
    </e-dialog-buttons>
    <e-content-template>
...
```csharp
<e-dialog-buttons>
    <e-dialog-button content="Save" is-primary="true" on-click="onSave"></e-dialog-button>
    <e-dialog-button content="Save & Close" is-primary="true" on-click="onSaveClose"></e-dialog-button>
...
### Modal Not Working
- **Cause:** `is-modal="false"` or missing overlay CSS.
- **Solution:** Ensure `is-modal="true"` and CSS is loaded.
