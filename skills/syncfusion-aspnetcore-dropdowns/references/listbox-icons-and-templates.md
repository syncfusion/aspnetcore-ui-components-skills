...
<ejs-listbox id="listbox"
    ...
    groupTemplate="@Html.Raw("<div class='group-header'>${Category}</div>")"
    height="300px">
...
ViewBag.products = new List<Product>
{
    ...
    new Product { Id = 3, Name = "Shirt", Category = "Clothing" },
    new Product { Id = 4, Name = "Pants", Category = "Clothing" }
};
```
...
<ejs-listbox id="listbox"
    dataSource="@ViewBag.items"
    headerTemplate="@Html.Raw("<div class='list-header'><span>Available Items</span></div>")"
    height="300px">
    <e-listbox-fields text="Name" value="Id"></e-listbox-fields>
</ejs-listbox>
...
<ejs-listbox id="listbox"
    dataSource="@ViewBag.items"
    footerTemplate="@Html.Raw("<div class='list-footer'><span>Total: ${ItemCount}</span></div>")"
    height="300px">
    <e-listbox-fields text="Name" value="Id"></e-listbox-fields>
</ejs-listbox>
...
<ejs-listbox id="listbox"
    dataSource="@ViewBag.items"
    headerTemplate="@Html.Raw("<div class='list-header'><strong>Items</strong><input type='search' class='search-box' placeholder='Filter...'/></div>")"
    footerTemplate="@Html.Raw("<div class='list-footer'><span>Total: ${ItemCount}</span></div>")"
    height="350px">
    <e-listbox-fields text="Name" value="Id"></e-listbox-fields>
</ejs-listbox>
