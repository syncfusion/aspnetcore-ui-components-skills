...
- [Range Slider Types](#range-slider-types)
...
Single thumb for selecting a value:

**Razor View (CSHTML):**
```html
<ejs-slider id="single" 
                 min="0" 
                 max="100" 
                 value="50"
                 type="single">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <div class="d-flex justify-content-between mt-2">
                    <span id="minPrice">$50</span>
                    <span id="maxPrice">$350</span>
                </div>
            </div>
            ...
            <!-- Reset Button -->
            <button class="btn btn-outline-secondary w-100 mt-2" onclick="resetFilter()">
                Reset
            </button>
        </div>
    </div>
...
<script>
    ...
    function applyFilter() {
        const slider = document.getElementById('priceSlider').ej2_instances[0];
        console.log('Filter applied:', {
            minPrice: slider.startValue,
            maxPrice: slider.endValue
        });
        // Make API call to filter products
    }
    ...
    function resetFilter() {
        ...
        slider.startValue = 0;
        slider.endValue = 500;
        updatePriceRange({ startValue: 0, endValue: 500 });
    }
</script>
```
