...
Install the Syncfusion.EJ2.AspNetCore NuGet package via Package Manager Console:

```powershell
Install-Package Syncfusion.EJ2.AspNetCore -Version 24.1.48
```

Or search for "Syncfusion.EJ2.AspNetCore" in NuGet Package Manager GUI and install.
...
- **Tailwind:** `https://cdn.syncfusion.com/ej2/24.1.48/tailwind.css`
...
The `<ejs-scripts>` TagHelper initializes Syncfusion controls and must be called once per page.
