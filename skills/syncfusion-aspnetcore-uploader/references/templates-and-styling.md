...
function onUploading(args) {
    // Update progress bar in template
    var progressPercent = args.percentComplete * 100;
    // Update progress-fill width based on file in args
}
</script>
```
...
```html
<ejs-uploader id="uploader">
    <e-upload-buttons browse-button-text="Choose Image" 
                      upload-button-text="Start Upload" 
                      clear-button-text="Remove All"></e-upload-buttons>
    <e-async-settings save-url="Home/Save" remove-url="Home/Remove"></e-async-settings>
</ejs-uploader>
```
...
<ejs-uploader id="uploader"
    ...
    css-class="custom-uploader">
    <e-upload-buttons browse-button-text="Select Files" 
                      upload-button-text="Upload" 
                      clear-button-text="Clear"></e-upload-buttons>
    <e-async-settings save-url="Home/Save" remove-url="Home/Remove"></e-async-settings>
</ejs-uploader>
```
...
|---------------|----------|---------|
| File list HTML | `template` | Custom template HTML |
| Button text | `browse-button-text` | `browse-button-text="Choose"` |
| CSS styling | `css-class` | `css-class="custom-class"` |
